...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listWorkflowStepTypes_200_response")]
    public partial class ListWorkflowStepTypes200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWorkflowStepTypes200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListWorkflowStepTypes200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWorkflowStepTypes200Response" /> class.
        /// </summary>
        /// <param name="stepTypes">stepTypes (required).</param>
        public ListWorkflowStepTypes200Response(List<Object> stepTypes = default)
        {
            // to ensure "stepTypes" is required (not null)
            if (stepTypes == null)
            {
                throw new ArgumentNullException("stepTypes is a required property for ListWorkflowStepTypes200Response and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "stepTypes", IsRequired = true, EmitDefaultValue = true)]
        public List<Object> StepTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListWorkflowStepTypes200Response {\n");
