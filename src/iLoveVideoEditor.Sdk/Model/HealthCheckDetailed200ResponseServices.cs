...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "healthCheckDetailed_200_response_services")]
    public partial class HealthCheckDetailed200ResponseServices : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HealthCheckDetailed200ResponseServices" /> class.
        /// </summary>
        /// <param name="redis">redis.</param>
        /// <param name="supabase">supabase.</param>
        public HealthCheckDetailed200ResponseServices(ServiceHealth redis = default, ServiceHealth supabase = default)
        {
            this.Redis = redis;
        ...
        /// <summary>
        /// Gets or Sets Supabase
        /// </summary>
        [DataMember(Name = "supabase", EmitDefaultValue = false)]
        public ServiceHealth Supabase { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HealthCheckDetailed200ResponseServices {\n");
            sb.Append("  Redis: ").Append(Redis).Append("\n");
            sb.Append("  Supabase: ").Append(Supabase).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
