...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getProject_200_response")]
    public partial class GetProject200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProject200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetProject200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProject200Response" /> class.
        /// </summary>
        /// <param name="project">project (required).</param>
        /// <param name="lastRendition">lastRendition.</param>
        public GetProject200Response(Project project = default, Rendition lastRendition = default)
        {
            // to ensure "project" is required (not null)
            if (project == null)
            {
                throw new ArgumentNullException("project is a required property for GetProject200Response and cannot be null");
            }
            this.Project = project;
            this.LastRendition = lastRendition;
        }
        ...
        /// <summary>
        /// Gets or Sets LastRendition
        /// </summary>
        [DataMember(Name = "lastRendition", EmitDefaultValue = false)]
        public Rendition LastRendition { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LastRendition: ").Append(LastRendition).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
