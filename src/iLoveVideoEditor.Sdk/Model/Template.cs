...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    public partial class Template : IValidatableObject
    {
        ...
        public Template(string id = default, string name = default, string description = default, PlatformEnum platform = default, string accentColor = default, string icon = default, ModeEnum mode = default, string toolId = default, List<Dictionary<string, Object>> variablesSchema = default)
        {
            ...
            if (accentColor == null)
            {
                throw new ArgumentNullException("accentColor is a required property for Template and cannot be null");
            }
            this.AccentColor = accentColor;
            // to ensure "icon" is required (not null)
            if (icon == null)
            {
                throw new ArgumentNullException("icon is a required property for Template and cannot be null");
            }
            this.Icon = icon;
            this.Mode = mode;
        ...
        /// </summary>
        [DataMember(Name = "variablesSchema", EmitDefaultValue = true)]
