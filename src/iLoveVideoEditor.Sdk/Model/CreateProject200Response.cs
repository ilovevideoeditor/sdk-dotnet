...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createProject_200_response")]
    public partial class CreateProject200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProject200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateProject200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProject200Response" /> class.
        /// </summary>
        /// <param name="project">project (required).</param>
        public CreateProject200Response(Project project = default)
        {
            // to ensure "project" is required (not null)
            if (project == null)
            {
                throw new ArgumentNullException("project is a required property for CreateProject200Response and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateProject200Response {\n");
