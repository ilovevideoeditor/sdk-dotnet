...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    public partial class Destination : IValidatableObject
    {
        ...
        public Destination(Guid id = default, ProviderEnum provider = default, string endpoint = default, string region = default, string bucket = default, string accessKeyId = default, string secretAccessKey = default, string publicUrl = default, string pathPrefix = default)
        {
            this.Id = id;
            ...
            if (bucket == null)
            {
                throw new ArgumentNullException("bucket is a required property for Destination and cannot be null");
            }
            this.Bucket = bucket;
            // to ensure "accessKeyId" is required (not null)
            if (accessKeyId == null)
            {
                throw new ArgumentNullException("accessKeyId is a required property for Destination and cannot be null");
            }
            this.AccessKeyId = accessKeyId;
            // to ensure "secretAccessKey" is required (not null)
            if (secretAccessKey == null)
            {
                throw new ArgumentNullException("secretAccessKey is a required property for Destination and cannot be null");
            }
