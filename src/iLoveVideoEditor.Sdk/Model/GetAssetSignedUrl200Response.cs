...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAssetSignedUrl_200_response")]
    public partial class GetAssetSignedUrl200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetSignedUrl200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAssetSignedUrl200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetSignedUrl200Response" /> class.
        /// </summary>
        /// <param name="signedUrl">signedUrl (required).</param>
        public GetAssetSignedUrl200Response(string signedUrl = default)
        {
            // to ensure "signedUrl" is required (not null)
            if (signedUrl == null)
            {
                throw new ArgumentNullException("signedUrl is a required property for GetAssetSignedUrl200Response and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAssetSignedUrl200Response {\n");
