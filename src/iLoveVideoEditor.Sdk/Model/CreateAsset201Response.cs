...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createAsset_201_response")]
    public partial class CreateAsset201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAsset201Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAsset201Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAsset201Response" /> class.
        /// </summary>
        /// <param name="asset">asset (required).</param>
        public CreateAsset201Response(Asset asset = default)
        {
            // to ensure "asset" is required (not null)
            if (asset == null)
            {
                throw new ArgumentNullException("asset is a required property for CreateAsset201Response and cannot be null");
            }
            this.Asset = asset;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAsset201Response {\n");
