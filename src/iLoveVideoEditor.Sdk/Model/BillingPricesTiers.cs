...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// BillingPricesTiers
    /// </summary>
    [DataContract(Name = "BillingPrices_tiers")]
    public partial class BillingPricesTiers : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingPricesTiers" /> class.
        /// </summary>
        /// <param name="starter">starter.</param>
        /// <param name="pro">pro.</param>
        /// <param name="business">business.</param>
        public BillingPricesTiers(string starter = default, string pro = default, string business = default)
        {
        ...
        /// <summary>
        /// Gets or Sets Starter
        /// </summary>
        [DataMember(Name = "starter", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BillingPricesTiers {\n");
