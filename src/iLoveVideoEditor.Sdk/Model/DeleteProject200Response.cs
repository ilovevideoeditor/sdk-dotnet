...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deleteProject_200_response")]
    public partial class DeleteProject200Response : IValidatableObject
    {
        ...
        protected DeleteProject200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteProject200Response" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="deleted">deleted (required).</param>
        public DeleteProject200Response(string id = default, bool deleted = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DeleteProject200Response and cannot be null");
            }
            this.Id = id;
