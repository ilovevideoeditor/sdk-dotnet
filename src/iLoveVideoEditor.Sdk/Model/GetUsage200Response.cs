...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    public partial class GetUsage200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUsage200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetUsage200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUsage200Response" /> class.
        /// </summary>
        /// <param name="usage">usage (required).</param>
        public GetUsage200Response(List<UsageLog> usage = default)
        {
            // to ensure "usage" is required (not null)
            if (usage == null)
            {
                throw new ArgumentNullException("usage is a required property for GetUsage200Response and cannot be null");
            }
            this.Usage = usage;
        }
