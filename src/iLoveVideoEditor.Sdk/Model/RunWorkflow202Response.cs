...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "runWorkflow_202_response")]
    public partial class RunWorkflow202Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RunWorkflow202Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RunWorkflow202Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RunWorkflow202Response" /> class.
        /// </summary>
        /// <param name="run">run (required).</param>
        public RunWorkflow202Response(WorkflowRun run = default)
        {
            // to ensure "run" is required (not null)
            if (run == null)
            {
                throw new ArgumentNullException("run is a required property for RunWorkflow202Response and cannot be null");
            }
            this.Run = run;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RunWorkflow202Response {\n");
