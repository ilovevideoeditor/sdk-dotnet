...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "batchDeleteProjects_request")]
    public partial class BatchDeleteProjectsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchDeleteProjectsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchDeleteProjectsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchDeleteProjectsRequest" /> class.
        /// </summary>
        /// <param name="ids">ids (required).</param>
        public BatchDeleteProjectsRequest(List<Guid> ids = default)
        {
            // to ensure "ids" is required (not null)
            if (ids == null)
            {
                throw new ArgumentNullException("ids is a required property for BatchDeleteProjectsRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchDeleteProjectsRequest {\n");
