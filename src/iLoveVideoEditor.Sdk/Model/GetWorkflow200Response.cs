...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    public partial class GetWorkflow200Response : IValidatableObject
    {
        ...
        protected GetWorkflow200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWorkflow200Response" /> class.
        /// </summary>
        /// <param name="workflow">workflow (required).</param>
        /// <param name="recentRuns">recentRuns.</param>
        public GetWorkflow200Response(Workflow workflow = default, List<WorkflowRun> recentRuns = default)
        {
            // to ensure "workflow" is required (not null)
            if (workflow == null)
            {
                throw new ArgumentNullException("workflow is a required property for GetWorkflow200Response and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets RecentRuns
        /// </summary>
        [DataMember(Name = "recentRuns", EmitDefaultValue = false)]
        public List<WorkflowRun> RecentRuns { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RecentRuns: ").Append(RecentRuns).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
