...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listWorkflowPresets_200_response")]
    public partial class ListWorkflowPresets200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWorkflowPresets200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListWorkflowPresets200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWorkflowPresets200Response" /> class.
        /// </summary>
        /// <param name="presets">presets (required).</param>
        public ListWorkflowPresets200Response(List<WorkflowPreset> presets = default)
        {
            // to ensure "presets" is required (not null)
            if (presets == null)
            {
                throw new ArgumentNullException("presets is a required property for ListWorkflowPresets200Response and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListWorkflowPresets200Response {\n");
