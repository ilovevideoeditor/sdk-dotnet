...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getWorkflowPreset_200_response")]
    public partial class GetWorkflowPreset200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWorkflowPreset200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWorkflowPreset200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWorkflowPreset200Response" /> class.
        /// </summary>
        /// <param name="preset">preset (required).</param>
        public GetWorkflowPreset200Response(WorkflowPreset preset = default)
        {
            // to ensure "preset" is required (not null)
            if (preset == null)
            {
                throw new ArgumentNullException("preset is a required property for GetWorkflowPreset200Response and cannot be null");
            }
            this.Preset = preset;
        }
        ...
        public WorkflowPreset Preset { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetWorkflowPreset200Response {\n");
