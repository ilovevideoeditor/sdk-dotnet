...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createWorkflow_201_response")]
    public partial class CreateWorkflow201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWorkflow201Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateWorkflow201Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWorkflow201Response" /> class.
        /// </summary>
        /// <param name="workflow">workflow (required).</param>
        public CreateWorkflow201Response(Workflow workflow = default)
        {
            // to ensure "workflow" is required (not null)
            if (workflow == null)
            {
                throw new ArgumentNullException("workflow is a required property for CreateWorkflow201Response and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateWorkflow201Response {\n");
