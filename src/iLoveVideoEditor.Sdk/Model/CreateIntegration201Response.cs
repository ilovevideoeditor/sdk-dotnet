...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    public partial class CreateIntegration201Response : IValidatableObject
    {
        ...
        protected CreateIntegration201Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIntegration201Response" /> class.
        /// </summary>
        /// <param name="integration">integration (required).</param>
        public CreateIntegration201Response(WorkspaceIntegration integration = default)
        {
            // to ensure "integration" is required (not null)
            if (integration == null)
            {
                throw new ArgumentNullException("integration is a required property for CreateIntegration201Response and cannot be null");
            }
        ...
        public WorkspaceIntegration Integration { get; set; }
