...
namespace iLoveVideoEditor.Sdk.Model
{
    ...
    public partial class GetDestination200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDestination200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetDestination200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDestination200Response" /> class.
        /// </summary>
        /// <param name="destination">destination (required).</param>
        public GetDestination200Response(Destination destination = default)
        {
            // to ensure "destination" is required (not null)
            if (destination == null)
            {
                throw new ArgumentNullException("destination is a required property for GetDestination200Response and cannot be null");
            }
